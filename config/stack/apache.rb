...
package :passenger, :provides => :appserver do
  ...
  gem 'passenger', :version => version do
    ...
    [%Q(LoadModule passenger_module /opt/ruby_ee/lib/ruby/gems/1.8/gems/passenger-#{version}/ext/apache2/mod_passenger.so),
    %Q(PassengerRoot /opt/ruby_ee/lib/ruby/gems/1.8/gems/passenger-#{version}),
    %q(PassengerRuby /opt/ruby_ee/bin/ruby),
    %q(RailsEnv production),
    %q(PassengerMaxPoolSize 2)].each do |line|
